        ...
        <div class="dashboard-content">
            ...
            <div style="display: none">
                <label for="stepTransition">
                    Step transition <input type="checkbox" id="stepTransition" name="stepTransition" value="11"
                                           checked/>
                </label>
                <br/>
                        ...
                        <div class="tsf-container ">
                            <!-- BEGIN CONTENT-->
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="edit-profile-photo">
                                                            <img class="profile-pic pic1" src="images/user-avatar.jpg"
                                                                 alt="">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <div class="select-search">
                                                                <input class="ss_input" type="text"
                                                                       data-select-search="sel1">
                                                                <select class="form-control crs-country "
                                                                        data-value="shortcode" data-region-id="one"
                                                                         id="sel1">
                                                                </select>
                                                            </div>
                                                        </div>
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="tsf-step-content">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="edit-profile-photo">
                                                            <img class="profile-pic pic3" src="images/user-avatar.jpg"
                                                                 alt="">
                                                            <div class="change-photo-btn">
                                                                <div class="photoUpload">
                                                                    <span><i class="fa fa-upload"></i> Upload Photo</span>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="edit-profile-photo">
                                                            <img class="profile-pic pic4" src="images/user-avatar.jpg"
                                                                 alt="">
                                                            <div class="change-photo-btn">
                                                                <div class="photoUpload">
                                                                    <span><i class="fa fa-upload "></i> Upload Photo</span>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="edit-profile-photo">
                                                            <img class="profile-pic pic5" src="images/user-avatar.jpg"
                                                                 alt="">
                                                            <div class="change-photo-btn">
                                                                <div class="photoUpload">
                                                                    <span><i class="fa fa-upload"></i> Upload Photo</span>
                                                ...
                                                <!--                                                            <input type="checkbox" name="condition3" id="condition3" data-parsley--message="You must accept the terms "  data-parsley-="true" >-->
                                                ...
                                                <!--                                                            <input type="checkbox" name="condition4" id="condition4" data-parsley--message="You must accept the terms "  data-parsley-="true" >-->
                                ...
                                <div class="tsf-controls ">
                                    ...
                                    <button type="submit" data-type="finish"
                                            class="btn button btn-right tsf-wizard-btn">
                                        FINISH
                                    </button>
                                    <!-- END FINISH BUTTTON-->
                                </div>
